...
cultural_background = input("Are you open to daiting people with diffrent cultural backgrounds? ")
...
print("I am looking for somone who is around" + age_range + ", the type of relationship I want is " + Type_Relationship + ". I will date somone who will have " + type_person + " intrests. But I am " + cultural_background + "to someone who has a cultural background")
print()
